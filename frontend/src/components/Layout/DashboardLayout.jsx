...
const DashboardLayout = ({ children }) => {
  ...
  const menuItems = [
    { name: 'Dashboard', path: '/dashboard', icon: LayoutDashboard, roles: ['Admin', 'Manager', 'Developer'] },
    { name: 'User Management', path: '/admin/users', icon: Users, roles: ['Admin'] },
    { name: 'Projects', path: '/manager/projects', icon: Briefcase, roles: ['Manager', 'Admin'] },
